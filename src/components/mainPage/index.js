...
import { getPostsData, addPost, inNeedUserSignup ,addComment} from '../../store/apiActions'
...
const MainPage = props => {
    ...
    useEffect(async () => {
        ...
        // let token = await inNeedUserSignup(user);
        // console.log('received token after signup>> ', token);

        //Handle add post
        //this token must come from cookie
        let token='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoic3RhdGljIHJlYWN0IHVzZXI1IiwibmF0aW9uYWxObyI6OTAxNTY2MTIzMSwiaWF0IjoxNjA0NTU2NzIzLCJleHAiOjE2MDQ1NjEyMjN9.BVGXAFzwes3QqqTizZud-xOPUbXSojwLncBXA3WPbGQ';
