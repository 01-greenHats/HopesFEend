...
function PostCard(props) {
    ...
    async function handleAddComment(e, postId) {
        e.preventDefault();
        if (! props.loggedIn) { // props.checkIsLogedIn()
            history.push("/userForm");
            return;
        }
        let comment = e.target.commentContent.value
        console.log(`postID : ${postId} // content : ${comment} // token : ${
            props.token
        }`)
        ...
        <>
            <div className="card gedf-card"
                ...
                <div class="card-body">
                    ...
                    <div class="text-muted h7 mb-2">
                        ...
                        {
                        new Date(props.post.createdTime).toLocaleDateString()
                    }</div>
                ...
                <div className="card-footer">
                    ...
                    <button id="viewCommentBtn" className="card-link"
                        onClick={
                            (e) => {
                                toggleControlePanel(e, props.post._id)
                            }
                ...
                <div className="box_comment col-md-11">
                    ...
                    <form onSubmit={
                        (e) => {
                            handleAddComment(e, props.post._id)
                        }
                    }>
                        ...
                        <textarea id="box_commentTextArea" name="commentContent" class="commentar" placeholder="Add a comment..."></textarea>
                                <button style={{width:"50px" ,Height:"40px"}} type="submit" value="1">Post</button>
                        </div>
                    </form>
                </div>
            ...
            <div className="row">
                ...
                <div id={
                    ...
                    className="result_comment col-md-11">
    ...
    // return (
    //     <>
    //         <div className="card gedf-card" style={{ boxShadow: "3px 3px 6px #a6a4a4"}}>
    //             <div className="card-header">
    //                 <div className="d-flex justify-content-between align-items-center">
    //                     <div className="d-flex justify-content-between align-items-center">
    //                         <div className="mr-2">
    ...
    //                      <img src="https://static.xx.fbcdn.net/rsrc.php/v1/yi/r/odA9sNLrE86.jpg" style={{width:"4%",borderRadius:"50%",padding:"7px 0px"}} alt="avatar" />
...
const mapStateToProps = state => ({token: state.auth.token, loggedIn: state.auth.loggedIn});
